...
select extensions.ok(
  ...
  'FlowProperty UPDATE fence excludes only the three derivative columns'
);
...
select extensions.ok(
  ...
  'UnitGroup UPDATE fence excludes only the three derivative columns'
);
...
select extensions.lives_ok(
  $test$
    ...
    where id = 'fa327000-0000-4000-8000-000000000005'::uuid
  $test$,
  'embedding value/timestamp FlowProperty update bypasses a busy actor fence'
);
...
select extensions.lives_ok(
  $test$
    ...
    where id = 'fa327000-0000-4000-8000-000000000006'::uuid
  $test$,
  'embedding value/timestamp UnitGroup update bypasses a busy actor fence'
);
